  ...
  return (
    <div className="min-h-screen bg-[#F5F5FA] text-[#171721]">
      <header className="fixed left-0 right-0 top-0 z-30 flex h-16 items-center border-b border-[#E4E6E8] bg-white/95 px-4 backdrop-blur">
        <button className="mr-3 inline-flex h-10 w-10 items-center justify-center rounded-lg border border-[#E4E6E8] lg:hidden">
          <Menu size={20} />
        </button>
        <BrandLogo />
        ...
        <div className="ml-3 flex items-center gap-2">
          <button className="inline-flex h-10 w-10 items-center justify-center rounded-lg border border-[#E4E6E8] bg-white">
            <Bell size={18} />
          </button>
          <button className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-[#171721] text-white">
            <UserRound size={18} />
          </button>
        </div>
      </header>
